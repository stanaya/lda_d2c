...
Usage:
  fetchJSON.py <corpus_dir> <outfile>
  fetchJSON.py (-h | --help)
  fetchJSON.py --version
...
if __name__ == '__main__':
    arguments = docopt(__doc__, version='fetchJSON 0.1')
    main(corpus_dir=arguments[r'<corpus_dir>'],
         outfile=arguments[r'<outfile>'])
